from nexus.simulator.spatial.layers.chemical import ChemicalLayer


class FreeField:
    """
    FreeField class for a field in the FreeMesh class. Used to represent the field inside the FreeMesh

    """

    def __init__(self, pos, D, key, vol, id, cfg):
        """
        GridField class for FreeMesh cell.
