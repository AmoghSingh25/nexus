...
def calc_inter_cell_force(
    ...
    unit_force_vectors = force_vectors / jnp.linalg.norm(force_vectors, axis=1, ord=2)

    # Calculate force so cells do not overlap in 3 simulation steps
    repulsion_acc = overlap_cells_mask * (combined_cell_sizes - dists) / 4.5
